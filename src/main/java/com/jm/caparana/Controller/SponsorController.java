...
public class SponsorController {
    ...
    public ResponseEntity<SponsorDTO> createSponsor(@RequestParam("name") String name, @RequestParam("image") MultipartFile image) throws IOException {
        return new ResponseEntity<>(sponsorService.createSponsor(name,image),HttpStatus.CREATED);
    }
